...
export function NoteCard({ id, date, content, onNoteDeleted }: NoteCardProps) {
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal> {/* Transfere tudo que estiver dentro da tag para dentro da tag body */}
                ...
                <Dialog.Content className="fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[40rem] w-full md:h-[60vh] bg-slate-700 md:rounded-md overflow-hidden flex flex-col outline-none">
                    ...
                    > {/* Para aplicar estilos nos elementos filhos baseado em uma interação no elemento pai, coloca-se a classe "group" no elemento pai para criar um grupo */}
